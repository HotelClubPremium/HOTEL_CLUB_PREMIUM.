...
<form name="form1" id="form1" method="post" action="/HOTEL_CLUB_PREMIUM/usuario/guardarclave">
<table width="440" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="251"><input name="cod_usuario" type="text" id="cod_usuario" readonly="readonly" value="<?php echo $cod_usuario; ?>" /></td>
  </tr>
  <tr>
    <td>Usuario</td>
    <td><input name="nom_usuario" type="text" id="nom_usuario" readonly="readonly" value="<?php echo $nom_usuario; ?>"  /></td>
  </tr>
  <tr>
