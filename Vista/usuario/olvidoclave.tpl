...
<form name="form1" id="form1" method="post" action="/HOTEL_CLUB_PREMIUM/usuario/enviardatosolvido">
<table width="440" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="251"><input type="text" name="cod_usuario" id="cod_usuario" /></td>
  </tr>
  <tr>
